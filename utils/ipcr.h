...
#define KEY_SYMB1       'y'
#define KEY_SYMB2       'r'
#define MAX_IPC_LENGHT 	1024
#define MAX_CHAR	128
#define MAX_LINE_LENGHT	1024

struct GpioData
{
  int da[MAX_IPC_LENGHT];	//Vector for synchronization: description below
  int tx[MAX_LINE_LENGHT];	//Running text: letters as indexes
  unsigned char ch[MAX_CHAR][8];//Current chars' pictures
};

//initial char picture
static unsigned char cc[MAX_CHAR][8]={
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},   // U+0000 (nul)
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80},   // U+0001
...
{0x0C,0x0E,0x0C,0x0C,0x0C,0x0C,0x3F,0x0},//1
{0x0,0xF9,0x89,0x89,0x89,0x89,0x8F,0x0},//2
{0x0,0x0,0x49,0x49,0x49,0x49,0x7F,0x0},//3
{0x0,0x7e,0x81,0x81,0x81,0x81,0x7e,0x0},//0
{0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0},//space
};
*/
  key_t keyshm;
